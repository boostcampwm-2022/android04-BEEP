...
import com.lighthouse.beep.model.location.NextLocation
...
object LocationConverter {
    ...
    private fun getMinutes(coordinateToDouble: Double, degree: Int) =
        getDegree((coordinateToDouble - degree) * 60)
