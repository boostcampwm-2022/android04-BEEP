package com.lighthouse.presentation.ui.map.prev
...
@AndroidEntryPoint
class PrevMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private val viewModel: PrevViewModel by viewModels()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapView = binding.mapView.apply {
            ...
            getMapAsync(this@PrevMapActivity)
        }
