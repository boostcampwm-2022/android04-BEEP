package com.lighthouse.data.storage.repository
...
internal class GifticonStorageRepositoryImpl @Inject constructor(
    ...
    override suspend fun updateCropImage(
        userId: String,
        inputCropUri: Uri?
    ...
    override suspend fun deleteFile(uri: Uri): Result<Unit> = runCatching {
